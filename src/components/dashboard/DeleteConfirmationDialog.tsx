...
export function DeleteConfirmationDialog({
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <AlertDialogContent className="max-w-md" data-test-id="delete-confirmation-dialog">
        <AlertDialogHeader>
        ...
        <AlertDialogFooter className="gap-2 sm:gap-0">
          <AlertDialogCancel onClick={onClose} className="w-full sm:w-auto" data-test-id="cancel-button">
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            onClick={() => {
